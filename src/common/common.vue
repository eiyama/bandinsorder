...
var arro = ["51", "52", "53", "59", "11", "13", "19"],arre = ["91", "92", "93"];
export default
{
	Public: {
		/**
        ...
        */
		cardTypeChange: function(value1,value2){
	        var cardTypeData = cardType.result, idType = '', relationType = '';
        ...
        */
		cardTypeChangeTxt: function(value1,value2){
	        var cardTypeData = cardType.result, txt = '', idTypeTxt = '', relationTypeTxt = '';
        ...
        */
        judgeCarType: function ($this, thisVal, orgName, cardType, relationPeopleType, carTypeUrl) {
            var isApiCheck = false, thisVal = thisVal.replace(/\s/g, "");
